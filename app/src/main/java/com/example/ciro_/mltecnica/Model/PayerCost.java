...
public class PayerCost {
    ...
    public PayerCost(Integer installments, Double installmentRate, Integer discountRate, List<String> labels, List<String> installmentRateCollector, Integer minAllowedAmount, Integer maxAllowedAmount, String recommendedMessage, Double installmentAmount, Double totalAmount) {
        this.installments = installments;
        this.installmentRate = installmentRate;
        this.discountRate = discountRate;
        this.labels = labels;
