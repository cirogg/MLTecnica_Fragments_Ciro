...
public class SpinnerAdapterBanco extends BaseAdapter {
    ...
    public SpinnerAdapterBanco(List<String> listaDeTexto, Activity activity, List<Banco> listaDeBancos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(view)
                .load(listaDeBancos.get(position).getThumbnail())
                .into(imageView);
